...
export const metadata: Metadata = {
    title: "About me",
    description:
        "About Jan Skiba, software developer focused on modern Angular and TypeScript web applications.",
                ...
                <div className="group relative overflow-hidden rounded-2xl p-6 sm:p-8 border border-gray-700/50 backdrop-blur-sm bg-linear-to-br from-gray-800/50 to-gray-900/50 hover:border-blue-500/40 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10">
                    ...
                    <div className="relative grid gap-6 sm:grid-cols-[120px_1fr] sm:items-start">
                        ...
                        <div className="flex sm:block mx-auto">
                            <div className="relative h-24 w-24 sm:h-28 sm:w-28 rounded-2xl overflow-hidden border border-gray-700/60 bg-gray-800/40">
                                <Image
                                    src={mePhoto}
                                    alt="Profile photo"
                                    fill
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="mt-2 text-gray-300 leading-relaxed">
                                    ...
                                    maintainable web applications—mostly in the Angular ecosystem.
                                    I enjoy turning complex requirements into clean UI, solid
                                    architecture, and reliable delivery pipelines.
                                </p>
                            </div>

                            <p className="text-gray-300 leading-relaxed">
                                My go-to stack includes Angular and Angular Material, along with
                                TypeScript and SCSS. I also have extensive experience in working
                                with complex maps in leaflet.
                            </p>

                            <p className="text-gray-300 leading-relaxed">
                                Quality matters to me, so I regularly write automated tests with
                                Cypress, Playwright, and Jasmine. On the tooling side, I'm
                                comfortable with Linux, Docker, Jenkins, Bitbucket, Git, and
                                Jira.
                            </p>

                            <p className="text-gray-400">
                                When I'm not coding, I'm usually listening to heavy music,
                                playing guitar, or spending time with my wife and our dog.
                            </p>
                            ...
                            <div className="pt-2">
                                <ArrowLink href="/blog" text="Read my articles" direction="forward" />
                            </div>
                        </div>
                    </div>
                </div>
