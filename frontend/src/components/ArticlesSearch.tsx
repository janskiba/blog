...
export function ArticlesSearch({ articles }: { articles: Article[] }) {
                ...
                {filtered.length === 0 ? (
                    ...
                    <div className="space-y-6">
                        {filtered.map((article) => (
                            ...
                            >
                                <div className="absolute inset-0 bg-linear-to-r from-blue-500/0 via-purple-500/0 to-pink-500/0 group-hover:from-blue-500/5 group-hover:via-purple-500/5 group-hover:to-pink-500/5 rounded-2xl transition-all duration-300" />
